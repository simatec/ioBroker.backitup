        ...
        if (options.matrix.enabled &&
            ...
            if (!errors.length) {
                ...
                if (options.matrix.onlyError === false || options.matrix.onlyError === 'false') {
                    options.adapter.sendTo(options.matrix.instance, { html: `Backitup:\n'${messageText}`, text: `Backitup:\n'${messageText}` });
                }
            } else {
