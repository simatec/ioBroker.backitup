...
async function command(options, log, callback) {
    ...
    // Token refresh
    if (options.dropboxTokenType == 'shortLive') {
        db_accessToken = await refreshToken(options.dropboxAccessJson, options.dropboxClient_id, options.dropboxClient_secret, log);
    } else if (options.dropboxTokenType == 'longLive') {
