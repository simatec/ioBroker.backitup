    ...
    setTimeout(function () {
        if (options.telegram.enabled &&
            ...
            if (JSON.stringify(options.context.errors) === '{}') {
                ...
                if (options.onedrive && options.onedrive.enabled && options.telegram.NoticeType === 'longTelegramNotice') {
                    messageText += _(', and stored in onedrive', options.telegram.systemLang);
                }
