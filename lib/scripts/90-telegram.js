    ...
    setTimeout(function() {
        if (options.telegram.enabled &&
            ...
            if (JSON.stringify(options.context.errors) === '{}') {
                ...
                if (options.context.errors.mount && options.cifs.pass !== undefined) {
                ...
                if (options.context.errors.umount && options.cifs.pass !== undefined) {
