    ...
    setTimeout(function () {
        if (options.whatsapp.enabled &&
            ...
            if (JSON.stringify(options.context.errors) === '{}') {
                ...
                messageText = messageText.replace('%t', options.whatsapp.time).replace('%e', options.name);
                ...
                if (options.webdav && options.webdav.enabled && options.telegram.NoticeType === 'longWhatsappNotice') {
