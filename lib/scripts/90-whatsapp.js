    ...
    setTimeout(function () {
        if (options.whatsapp.enabled &&
            ...
            if (!errors.length) {
                ...
                if (options.onedrive && options.onedrive.enabled && options.whatsapp.NoticeType === 'longWhatsappNotice') {
                    messageText += _(', and stored in onedrive', options.whatsapp.systemLang);
                }
