...
async function command(options, log, callback) {
    ...
    // instance objects (adapter configuration/native settings)
    const instanceObj = await options.adapter.getForeignObjectsAsync('system.adapter.solectrus-influxdb.*');
