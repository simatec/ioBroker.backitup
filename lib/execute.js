        ...
        if (scripts.hasOwnProperty(name) && scripts[name] && (!config.afterBackup || scripts[name].afterBackup)) {
            ...
            if (func) {
                try {
                    ...
                    if (_options.solectrusInfluxdb && !_options.solectrusInfluxdb.enabled) delete _options.solectrusInfluxdb;
                    ...
                    if (_options.solectrusInfluxdb && _options.solectrusInfluxdb.backupDir !== undefined) delete _options.solectrusInfluxdb.backupDir;
