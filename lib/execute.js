...
=======
                    ...
                    if (config.name === 'iobroker' && config[name] && config[name].enabled && config[name].SqlConnectionType === 'PostgesSQL') {
>>>>>>> dev
                        func = scripts[name];
...
>>>>>>> dev
                case 'mysql':
                    if (config.name === 'iobroker' && config[name] && config[name].enabled && config[name].SqlConnectionType === 'MySQL') {
                        func = scripts[name];
                        options = Object.assign({}, config[name]);
                    }
                    break;
            ...
            if (func) {
                ...
                if (_options.mysql  && !_options.sql.enabled) delete _options.mysql;
                if (_options.pgsql  && !_options.sql.enabled) delete _options.pgsql; // need verbose
                ...
                if (_options.pgsql  && _options.pgsql.backupDir !== undefined) delete _options.pgsql.backupDir;// need verbose
                ...
                if (_options.pgsql && _options.pgsql.pass !== undefined) _options.pgsql.pass = '****';
                ...
                for (const i in _options) {
                    ...
                    if (_options[i] !== null && _options[i].pgsql && _options[i].pgsql !== undefined) _options[i].pgsql.pass = '****';
