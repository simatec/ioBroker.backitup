...
function list(restoreSource, options, types, log, callback) {
    ...
    const gd_accessJson = typeof (options.accessJson) !== undefined ? options.accessJson : typeof (options.googledrive.accessJson) !== undefined ? options.googledrive.accessJson : '';
    const gd_dir = typeof (options.dir) !== undefined ? options.dir : typeof (options.googledrive.dir) !== undefined ? options.googledrive.dir : '/';
    const gd_ownDir = typeof (options.ownDir) !== undefined ? options.ownDir : typeof (options.googledrive.ownDir) !== undefined ? options.googledrive.ownDir : false;
    const gd_dirMinimal = typeof (options.dirMinimal) !== undefined ? options.dirMinimal : typeof (options.googledrive.dirMinimal) !== undefined ? options.googledrive.dirMinimal : '/';
