...
async function list(restoreSource, options, types, log, callback) {
    ...
    const db_dropboxAccessJson = options.dropboxAccessJson !== undefined && db_dropboxTokenType == 'default' ? options.dropboxAccessJson : options.dropbox.dropboxAccessJson !== undefined && db_dropboxTokenType == 'default'? options.dropbox.dropboxAccessJson : '';
