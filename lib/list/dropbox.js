...
async function list(restoreSource, options, types, log, callback) {
    ...
    if (!restoreSource || restoreSource === 'dropbox') {
        if (db_dropboxTokenType == 'default') {
            db_dropboxAccessJson = options.dropboxAccessJson !== undefined ? options.dropboxAccessJson : options.dropbox.dropboxAccessJson !== undefined ? options.dropbox.dropboxAccessJson : '';
