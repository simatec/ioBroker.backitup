...
function list(restoreSource, options, types, log, callback) {
    ...
    const ftp_host = typeof (options.host) !== undefined ? options.host : typeof (options.ftp.host) !== undefined ? options.ftp.host : '';
    const ftp_user = typeof (options.user) !== undefined ? options.user : typeof (options.ftp.user) !== undefined ? options.ftp.user : '';
    const ftp_pass = typeof (options.pass) !== undefined ? options.pass : typeof (options.ftp.pass) !== undefined ? options.ftp.pass : '';
    const ftp_port = typeof (options.port) !== undefined ? options.port : typeof (options.ftp.port) !== undefined ? options.ftp.port : 21;
    const ftp_dir = typeof (options.dir) !== undefined ? options.dir : typeof (options.ftp.dir) !== undefined ? options.ftp.dir : '/';
    const ftp_ownDir = typeof (options.ownDir) !== undefined ? options.ownDir : typeof (options.ftp.ownDir) !== undefined ? options.ftp.ownDir : false;
    const ftp_dirMinimal = typeof (options.dirMinimal) !== undefined ? options.dirMinimal : typeof (options.ftp.dirMinimal) !== undefined ? options.ftp.dirMinimal : '/';
