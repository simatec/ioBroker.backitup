...
class TokenRefresher {
    ...
    async refreshTokens() {
        ...
        if (expiresIn <= 0) {
            ...
            this.accessToken.access_token = response?.data.access_token;
            this.accessToken.expires_in = response?.data.expires_in;
            this.accessToken.access_token_expires_on = response?.data.access_token_expires_on;
