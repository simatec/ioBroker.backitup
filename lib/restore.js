...
function restore(adapter, options, storageType, fileName, log, callback) {
    ...
    localHost = options.host ? options.host : localHost;
...
function restoreIF() {
    ...
    app.get('/backitup-restore.html', function (req, res) {
        ...
        let content = (
            ...
            '       </div>' +
            '       <div class="row">' +
            '           <a href="' + localHost + '" class="status" style="color: lightskyblue; display: ' + (startFinish ? 'initial;' : 'none;') + '">Please open your ioBroker here</a>' +
