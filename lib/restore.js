...
function restoreIF(currentTheme) {
    ...
    app.get('/backitup-restore.html', function (req, res) {
        ...
        style += '.chip { background-color: #2a3135; box-shadow: 0 3px 3px 0 rgb(0 0 0 / 14%), 0 1px 5px 0 rgb(0 0 0 / 12%), 0 3px 1px -2px rgb(0 0 0 / 20%); margin-left: 20px; margin-right: 20px; padding: 0.2rem; }';
