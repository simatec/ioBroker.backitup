...
function restoreIF(currentTheme) {
    ...
    app.get('/backitup-restore.html', function (req, res) {
        ...
        script += `var _refresh = setInterval(function() { $("#backButton").load(" #backButton");$("#logInput").load(" #logInput");var restoreState = $("input").val();if (restoreState == '[Restore]') { $("#logText").load(" #logText") }`;
        ...
        let content = (
            ...
            '       </div>' +
            '       <div class="row">' +
            '           <div class="col s12" id="backButton" style="text-align: center">' +
