...
function restore(adapter, options, storageType, fileName, currentTheme, restoreIf, log, callback) {
...
function restoreIF(currentTheme, restoreIf) {
...
if (typeof module !== "undefined" && module.parent) {
    ...
    if (fs.existsSync(__dirname + '/restore.json')) {
		...
		startFinish = '[Restore]';
        restoreIF(config.theme, config.webif);
        ...
        restore(null, config, null, null, null, null, log, () => startIOB());
    } else {
