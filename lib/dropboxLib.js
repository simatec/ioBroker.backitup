    ...
    getAuthorizeUrl(log) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                log.warn('error getAuthorizeUrl Dropbox: ' + e);
                reject();
            }
        });
    }
        ...
        return new Promise((resolve, reject) => {
            if (dropboxCodeChallenge && dropboxCodeChallenge.length == 48) {
                ...
                try {
                    ...
                    log.warn('error getCodeChallage Dropbox: ' + e);
                    reject();
                }
            }
        });
    ...
    getRefreshToken(code, code_verifier, log) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                log.warn('error getRefreshToken Dropbox: ' + e);
                reject();
            }
        });
    }
    ...
    getClientID(log) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                log.warn('error getClientID Dropbox: ' + e);
                reject();
            }
        });
    }
    ...
    getToken(refreshToken, log) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                log.warn('error getToken Dropbox: ' + e);
                reject();
            }
        });
    }
