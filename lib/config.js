...
exports.decryptEvents = decryptEvents;
 ...
 * @param secret
 */
function decryptEvents(config, secret) {
...
function initConfig(options) {
    ...
    const mysql = {
        ...
        dropbox: Object.assign({}, dropbox, options.config.dropboxOwnDir === true ? { dir: options.config.dropboxMinimalDir } : {}),
        onedrive: Object.assign({}, onedrive, options.config.onedriveOwnDir === true ? { dir: options.config.onedriveMinimalDir } : {}),
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
    ...
    const zigbee = {
        ...
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
        path: (0, node_path_1.join)((0, tools_1.getIobDir)(), 'iobroker-data'), // specify zigbee path
        nameSuffix: options.config.minimalNameSuffix.replace(/[.;, ]/g, '_'), // names addition, appended to the file name
        slaveSuffix: options.config.hostType === 'Slave' ? options.config.slaveNameSuffix : '',
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
    ...
    const esphome = {
        ...
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
        path: (0, node_path_1.join)((0, tools_1.getIobDir)(), 'iobroker-data'), // specify esphome path
        nameSuffix: options.config.minimalNameSuffix.replace(/[.;, ]/g, '_'), // names addition, appended to the file name
        slaveSuffix: options.config.hostType === 'Slave' ? options.config.slaveNameSuffix : '',
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
    ...
    const nodered = {
        ...
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
        path: (0, node_path_1.join)((0, tools_1.getIobDir)(), 'iobroker-data'), // specify Node-Red path
        nameSuffix: options.config.minimalNameSuffix.replace(/[.;, ]/g, '_'), // names addition, appended to the file name
        slaveSuffix: options.config.hostType === 'Slave' ? options.config.slaveNameSuffix : '',
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
    ...
    const yahka = {
        ...
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
        path: (0, node_path_1.join)((0, tools_1.getIobDir)(), 'iobroker-data'), // specify yahka path
        nameSuffix: options.config.minimalNameSuffix.replace(/[.;, ]/g, '_'), // names addition, appended to the file name
        slaveSuffix: options.config.hostType === 'Slave' ? options.config.slaveNameSuffix : '',
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
    ...
    const jarvis = {
        ...
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavMinimalDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveMinimalDir } : {}),
        path: (0, node_path_1.join)((0, tools_1.getIobDir)(), 'iobroker-data'), // specify jarvis backup path
        nameSuffix: options.config.minimalNameSuffix.replace(/[.;, ]/g, '_'), // names addition, appended to the file name
        slaveSuffix: options.config.hostType === 'Slave' ? options.config.slaveNameSuffix : '',
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
    ...
    const grafana = {
        ...
        hostType: options.config.hostType,
        ignoreErrors: options.config.ignoreErrors,
        signedCertificates: options.config.grafanaProtocol === 'https' ? options.config.grafanaSignedCertificates : true,
    };
    ...
    const ccu = {
        ...
        dropbox: Object.assign({}, dropbox, options.config.dropboxOwnDir === true ? { dir: options.config.dropboxCcuDir } : {}),
        onedrive: Object.assign({}, onedrive, options.config.onedriveOwnDir === true ? { dir: options.config.onedriveCcuDir } : {}),
        webdav: Object.assign({}, webdav, options.config.webdavOwnDir === true ? { dir: options.config.webdavCcuDir } : {}),
        googledrive: Object.assign({}, googledrive, options.config.googledriveOwnDir === true ? { dir: options.config.googledriveCcuDir } : {}),
        historyHTML,
        historyJSON,
        telegram,
        email,
