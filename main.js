...
function main() {
    ...
    // adapter.config:
    adapter.log.info('config mBackupState: '    + adapter.config.mBackupState);
    adapter.log.info('config mBackupZeit: '    + adapter.config.mBackupZeit);
    adapter.log.info('config mBackupTageZyklus: ' + adapter.config.mBackupTageZyklus);
