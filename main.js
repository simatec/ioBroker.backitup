...
// W�rde ich in die Konfigoberfl�che integrieren --- Objekt zum Prüfen ob IoBroker wegen einem kompletten Backup neu gestartet ist.
...
//Neu seit V2 HistoryLog f�r die ausgeführen Backups
...
function backup_erstellen(typ, name, zeit, host, pfad, user, passwd, ccuip, ccuusr, ccupw, cifsmnt, bkpiors, mysqldb, mysqlusr, mysqlpw, mysqlln) {
    ...
    adapter.setState('History.letztes_'+typ+'_Backup', { val: DatumUhrzeitString(new Date()), ack: true });
