...
`,d=(0,E.Ay)("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),h=(0,E.Ay)(s,{name:"MuiTouchRipple",slot:"Ripple"})`
  opacity: 0;
  position: absolute;
...
`,s=typeof v!="string"?(0,T.css)`
        animation: ${v} 2s ease-in-out 0.5s infinite;
      `:null,a=typeof i!="string"?(0,T.css)`
        &::after {
