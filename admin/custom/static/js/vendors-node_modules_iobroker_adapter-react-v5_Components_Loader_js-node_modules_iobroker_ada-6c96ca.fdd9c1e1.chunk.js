"use strict";var B=Object.defineProperty,q=Object.defineProperties;var W=Object.getOwnPropertyDescriptors;var I=Object.getOwnPropertySymbols;var U=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var F=Math.pow,A=(x,k,y)=>k in x?B(x,k,{enumerable:!0,configurable:!0,writable:!0,value:y}):x[k]=y,M=(x,k)=>{for(var y in k||(k={}))U.call(k,y)&&A(x,y,k[y]);if(I)for(var y of I(k))j.call(k,y)&&A(x,y,k[y]);return x},L=(x,k)=>q(x,W(k));var $=(x,k,y)=>new Promise((E,b)=>{var O=v=>{try{p(y.next(v))}catch(_){b(_)}},w=v=>{try{p(y.throw(v))}catch(_){b(_)}},p=v=>v.done?E(v.value):Promise.resolve(v.value).then(O,w);p((y=y.apply(x,k)).next())});(self.webpackChunkiobroker_admin_component_backitup=self.webpackChunkiobroker_admin_component_backitup||[]).push([["vendors-node_modules_iobroker_adapter-react-v5_Components_Loader_js-node_modules_iobroker_ada-6c96ca"],{62023:(x,k)=>{Object.defineProperty(k,"__esModule",{value:!0});function y(){const p=document.getSelection();if(!(p!=null&&p.rangeCount))return()=>{};let v=document.activeElement;const _=[];for(let S=0;S<p.rangeCount;S++)_.push(p.getRangeAt(S));switch(v==null?void 0:v.tagName.toUpperCase()){case"INPUT":case"TEXTAREA":v.blur();break;default:v=null;break}return p.removeAllRanges(),()=>{p.type==="Caret"&&p.removeAllRanges(),p.rangeCount||_.forEach(S=>p.addRange(S)),v&&v.focus()}}const E={"text/plain":"Text","text/html":"Url",default:"Text"},b="Copy to clipboard: #{key}, Enter";function O(p){const v=`${/mac os x/i.test(navigator.userAgent)?"\u2318":"Ctrl"}+C`;return p.replace(/#{\s*key\s*}/g,v)}function w(p,v){let _,S,g,d,C=!1;v=v||{};const e=v.debug||!1;try{if(_=y(),S=document.createRange(),g=document.getSelection(),d=document.createElement("span"),d.textContent=p,d.ariaHidden="true",d.style.all="unset",d.style.position="fixed",d.style.top="0px",d.style.clip="rect(0, 0, 0, 0)",d.style.whiteSpace="pre",d.style.webkitUserSelect="text",d.style.MozUserSelect="text",d.style.msUserSelect="text",d.style.userSelect="text",d.addEventListener("copy",a=>{var o,n,l,t;if(a.stopPropagation(),v!=null&&v.format)if(a.preventDefault(),typeof a.clipboardData=="undefined"){e&&console.warn("unable to use e.clipboardData"),e&&console.warn("trying IE specific stuff"),(o=window.clipboardData)===null||o===void 0||o.clearData();const s=E[v.format]||E.default;(n=window.clipboardData)===null||n===void 0||n.setData(s,p)}else(l=a.clipboardData)===null||l===void 0||l.clearData(),(t=a.clipboardData)===null||t===void 0||t.setData(v.format,p)}),document.body.appendChild(d),S.selectNodeContents(d),g==null||g.addRange(S),!document.execCommand("copy"))throw new Error("copy command was unsuccessful");C=!0}catch(i){e&&console.error("unable to copy using execCommand: ",i),e&&console.warn("trying IE specific stuff");try{window.clipboardData.setData(v.format||"text",p),C=!0}catch(a){e&&console.error("unable to copy using clipboardData: ",a),e&&console.error("falling back to prompt");const o=O("message"in v?v.message||"":b);window.prompt(o,p)}}finally{g&&(S&&typeof g.removeRange=="function"?g.removeRange(S):g.removeAllRanges()),d&&document.body.removeChild(d),_&&_()}return C}k.default=w},59434:function(x,k,y){var E=this&&this.__createBinding||(Object.create?function(_,S,g,d){d===void 0&&(d=g);var C=Object.getOwnPropertyDescriptor(S,g);(!C||("get"in C?!S.__esModule:C.writable||C.configurable))&&(C={enumerable:!0,get:function(){return S[g]}}),Object.defineProperty(_,d,C)}:function(_,S,g,d){d===void 0&&(d=g),_[d]=S[g]}),b=this&&this.__setModuleDefault||(Object.create?function(_,S){Object.defineProperty(_,"default",{enumerable:!0,value:S})}:function(_,S){_.default=S}),O=this&&this.__importStar||function(_){if(_&&_.__esModule)return _;var S={};if(_!=null)for(var g in _)g!=="default"&&Object.prototype.hasOwnProperty.call(_,g)&&E(S,_,g);return b(S,_),S};Object.defineProperty(k,"__esModule",{value:!0});const w=O(y(28437)),p=`
/**
