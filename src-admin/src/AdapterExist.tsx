            ...
            <>
                <FormControlLabel
                    control={
                        <Checkbox
                            checked={
                                ((this.props.schema as ConfigItemCustom).adapter === 'hm-rpc' ||
                                    (this.props.schema as ConfigItemCustom).adapter === 'javascript' ||
                                    (this.props.schema as ConfigItemCustom).adapter === 'backitup') &&
                            ...
                            disabled={
                                (((this.props.schema as ConfigItemCustom).adapter === 'influxdb' ||
                                    (this.props.schema as ConfigItemCustom).adapter === 'sql') &&
                                ...
                                if (e.target.checked) {
                                    if ((this.props.schema as ConfigItemCustom).adapter) {
                                        this.checkAdapterInstall(
                                            ...
                                            (this.props.schema as ConfigItemCustom).allHosts,
                                        ).catch(err => console.error(err));
                                    } else if ((this.props.schema as ConfigItemCustom).alert) {
                                        this.setState({
                                            message: {
                                                text: I18n.t((this.props.schema as ConfigItemCustom).alert),
                                                title: I18n.t((this.props.schema as ConfigItemCustom).title),
                                            },
                                        });
                                    }
                                }
